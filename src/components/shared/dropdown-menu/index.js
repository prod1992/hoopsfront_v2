...
class DropDown extends Component {
    ...
    exportCatalogue() {
        ...
        let uri = getApiCredentials.host + "/api/exportcatalogue";
        ...
        return fetch(reqInstance)
            ...
            .then(data => {
                console.log('catalogue exported', data);
                return data;
    ...
    renderImportEditBtns(param) {
        if (param === 'CSV_IMPORT_ITEMS') {
            return (
                <div>
                    <div className='collapse-btn' onClick={this.props.openProductAddingModal}>
            ...
            return (
                <div className='collapse-btn'>
                    ...
                    <div
                        onClick={this.exportCatalogue}
                        className='collapse-btn-text'>CSV
                    </div>
                </div>
            )
