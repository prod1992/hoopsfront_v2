        ...
        return(
            <div className={viewType === PRODUCT_VIEW_TYPE['col_view'] ? item_view_class_name : grid_view_class_name}>
                <div className='custom-item'>
                            ...
                            <div className='catalogue-product-check'>
                                <div className='checkbox-ctrl'>
                                    <div className='custom-checkbox-style'>
                                        ...
                                        <input name='select_product' className='checkbox' type='checkbox'
                                               checked={catalogueStates.selectedAll || catalogueStates.selectedIds.includes(simpleProduct.id)}
                                               onChange={(event) => this.handleCheckProductId(event, simpleProduct['id'])}/>
                    ...
                    <Link to={`/catalogue/${simpleProduct.id}`} className='product-image-frame'>
    ...
    return(
        <div className='item-info'>
            ...
            <div className='custom-row'>
                ...
                <span className='price'>$<span>{simpleProduct.product_price || "0.00"}</span></span>
            </div>
            <div className='custom-row'>
                <div className='brand'>
                    <span>Brand</span>:
            ...
            <div className='custom-row'>
                <div className='category-row'>
                    <span>Category: <strong>{simpleProduct.category}</strong></span>
                    <span className="grey-text"> | </span>
                    <span>Vendor: <strong>Example</strong></span>
                </div>
            </div>
        </div>
    )
...
function GridItemView(props){
    ...
    return(
        <div className='item-info'>
            ...
            <div className='custom-row'>
                <div className='brand'>
                    <span>Brand: <strong>{simpleProduct.brand}</strong></span>
                </div>
