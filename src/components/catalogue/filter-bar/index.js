...
class FilterBar extends PureComponent {
  ...
  renderSuggestion(suggestion) {
    return <div className="suggest">{suggestion}</div>;
  }
  ...
  render() {
    ...
    return (
      <div
        className="catalogue-filter-bar"
        id={filterData.filterIsOpened === true ? "open" : null}
      >
        <div className="shared-scroll-view">
          <div className="filter_block">
                  ...
                  {selectedTags.map((tag, index) => {
                    return (
                      <div className="tag-item" key={index}>
                        {tag}
                        <i
                          className="material-icons remove-tag"
            ...
            <div className="apply-btn-wrapper">
              <button className="apply-btn" onClick={this.applyFilter}>
                Apply
              </button>
            </div>
            {/*<button onClick={this.clearFilters}
