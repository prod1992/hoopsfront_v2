...
import {setFilteredProductData, resetSelectedIds} from '../../../actions/catalogue-actions';
            ...
            <div className='bulk-edit-wrapper'>
                ...
                <div className='bulk-func-row'>
                    <div className='select-all-option'>
                        ...
                        <p className='selected-count'>Number of records <span>{selectedIds.length}</span> selected
                            records <span>{products['data'] && products['data'].length}</span></p>
                    </div>
