...
class SingleProduct extends Component {
    ...
    render() {
        ...
        console.log(product);
        return (
            product && <div className='single-product-wrapper'>
                <div className='single-product-data'>
                    <div className='product-img-wrap'>
                        <div className="image-wrapper-inner">
                            ...
                            <input type="file" ref={this.imageSelector} className="d-none"
                    ...
                    <div className='product-info'>
                        <div className='product-head-info'>
                            <div className='product-heading-column'>
                                <a href='' className='product-link-to'>{product.name}</a>
                            ...
                            <div className='tag-section'>
                                <div className='item'>
                                    ...
                                    <div className='tags-wrapper'>
                                        {product.colour && product.colour.map((colour, i) => (
                                            <span key={i} className='tag'>{colour}</span>
                                        ))}
                                    </div>
                                </div>
                                <div className='item'>
                                    ...
                                    <div className='tags-wrapper'>
                                        {product.size && product.size.map((size, i) => (
                                            <span key={i} className='sizes'>{size}</span>
                                        ))}
                                    </div>
                                </div>
                            </div>
                ...
                >
                    <EditingPopup closeModal={this.closeModal}
