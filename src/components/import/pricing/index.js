...
class Pricing extends Component {
    ...
    getService() {
        ...
        return (
            importFileData && importFileData.db_fields.map((item, index) => {
                if (index === 26) {
                    return (
                        <tr key={index}>
                            <td>
                                ...
                                <a href="http://help.hoopscrm.com/catalog/import-field-explanations/service-names"
                                   target="_blank"
                ...
                <div className="quantity_break_block_content">
                    <div className="quantity_break_block_items">
                        <div className="minimum_order_block_title">
                            ...
                            <button className="hoops_map_table_required_button">Required</button>
                            <a href="http://help.hoopscrm.com/catalog/import-field-explanations/moq-price-breaks"
                               target="_blank"
                               rel="noreferrer noopener"
                               className="what_this_link">What's This?</a>
                        </div>
