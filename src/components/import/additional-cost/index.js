            ...
            <div className="additional_cost_block" key={i+1000}>
                ...
                <div className="step_4_description">
                    <div className="description_items">
                        ...
                        <ImportedProperty propertyItem={{name: `description`}}
                                          propertyOptions={importFileData.csv_headers}/>
                    </div>
                    <div className="description_items">
                        <div className="minimum_order_block_title">
                            <h3>Notes</h3>
                            <button className="hoops_map_table_required_button d_none">Required</button>
                            <a href="#" className="what_this_link">What's This?</a>
                        </div>
                        <ImportedProperty propertyItem={{name: `notes`}}
                                          propertyOptions={importFileData.csv_headers}/>
                    </div>
                    <div className="description_items">
                        <div className="minimum_order_block_title">
                        ...
                        <ImportedProperty propertyItem={{name: `setup_cost`}}
                                          propertyOptions={importFileData.csv_headers}/>
                    </div>
                </div>
                {
                ...
                <div className="add_more_breaks">
                    <button onClick={() => this.addMorePriceBreaks(i)}>Add More Price Breaks</button>
                </div>
            </div>
        )
    }
    ...
    render(){
        return (
            <div className="product_mapping_block">
                    ...
                    <div className="step_3_catalogue_multiple_content">
                        <div className="step_3_catalogue_multiple_items">
                            <div className="step_3_catalogue_title">
                                ...
                                <a href="http://help.hoopscrm.com/catalog/import-field-explanations/service-options"
                                   rel="noreferrer noopener"
                                   target="_blank"
                                   className="what_this_link">What's This?</a>
                            </div>
                            <p className="standard_product_step_3">Eg. Standard Production, Rush Service, Indent etc</p>
                        </div>
                        <div className="step_3_catalogue_multiple_items">
                            <label className="step_3_catalogue_multiple_items_label">
                                <input type="radio" name="radio" value={1} onChange={this.toggleAdditionalBlock}/>
                                <span className="step_3_catalogue_multiple_items_label_checkmark"/>
                                Yes
                            </label>
                            <label className="step_3_catalogue_multiple_items_label">
                                <input type="radio" name="radio" value={2} onChange={this.toggleAdditionalBlock}/>
                                <span className="step_3_catalogue_multiple_items_label_checkmark"/>
                                No
                            </label>
                        </div>
                ...
                {
                    this.state.showAdditionalBlock && <div>
                            {this.getAdditionalBlockArray().map(item => item)}
                            <div className="add_more_breaks">
                                <button onClick={this.addMoreAdditionalBlock}>Add More Price Breaks</button>
                            </div>
                        </div>
